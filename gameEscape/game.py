...
#게임 이미지
backgroundIMG=pg.image.load('img/bgimg.PNG')
defaltIMG=pg.image.load('img/defaltimg.PNG')

Aevent2IMG=pg.image.load('img/aevent2.PNG')
Aevent3IMG=pg.image.load('img/aevent3.PNG')
Aevent4IMG=pg.image.load('img/aevent4.PNG')
Aevent5IMG=pg.image.load('img/aevent5.PNG')
Aevent6IMG=pg.image.load('img/aevent6.PNG')
Aevent8IMG=pg.image.load('img/aevent8.PNG')
Aevent10IMG=pg.image.load('img/aevent10.PNG')

titleIMG=pg.image.load('img/title.PNG')
startIMG=pg.image.load('img/startimg.PNG')
quitIMG=pg.image.load('img/quitimg.PNG')
startIMG2=pg.image.load('img/startimg2.PNG')
quitIMG2=pg.image.load('img/quitimg2.PNG')
gotitleIMG=pg.image.load('img/gotitleimg.PNG')
gotitleIMG2=pg.image.load('img/gotitleimg2.PNG')
characterIMG=pg.image.load('img/charimg.PNG')
endIMG=pg.image.load('img/endimg.PNG')

event1IMG=pg.image.load('img/event1.PNG')
event2IMG=pg.image.load('img/event2.PNG')
event3IMG=pg.image.load('img/event3.PNG')
event4IMG=pg.image.load('img/event4.PNG')
event5IMG=pg.image.load('img/event5.PNG')
event6IMG=pg.image.load('img/event6.PNG')
event7IMG=pg.image.load('img/event7.PNG')
event8IMG=pg.image.load('img/event8.PNG')
event9IMG=pg.image.load('img/event9.PNG')
event10IMG=pg.image.load('img/event10.PNG')
